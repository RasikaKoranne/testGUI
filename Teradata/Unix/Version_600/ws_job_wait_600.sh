...
# JML 15/04/2013  Version 6.7.1.0 Teradata UNIX Version
...
# BC  19/05/2015  Version 6.8.3.4 Added support for Hadoop scripts
...
# HM  21/08/2017  Version 8.0.1.0 RED-8566 Fix issue with scheduler jobs not starting on SunOS/Solaris due to '\\000' expanding into '^@'.
...
#
# Note: determine if running on SunOS/Solaris.
OS_NAME=`uname -s | tr -s '[:upper:]' '[:lower:]'`
